class EvidencesController < ApplicationController
  ...
  # GET /evidences.json
  def index
    evidences_scope = Evidence.order(:name)
    evidences_scope = evidences_scope.like(params[:filter]) if params[:filter]
    @evidences = smart_listing_create(:evidences, evidences_scope, partial: "evidences/china" )
  end
  ...
  private
    ...
    def evidence_params
      params.require(:evidence).permit(:name, :tag, :description, :date, :document)
    end
end
